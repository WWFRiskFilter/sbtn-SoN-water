...
```{r}
sharepoint_dir <- "C:\\Users\\liam.bailey\\WWF-Deutschland\\FB-WuM-Daten - Water & Biodiversity Stewardship"
```
...
'WRF\ws\_gis\\1_library\aqueduct\_4.0'

```{r}
bws <- st_read(file.path(sharepoint_dir, "WRF", "ws_gis", "1_library", "aqueduct_4.0", "aqueduct-4-0-water-risk-data", "Aqueduct40_waterrisk_download_Y2023M07D05", "GDB", "Aq40_Y2023D07M05.gdb"), layer = "baseline_annual")
```

#### 2.1.2. Water Depletion [Brauman et al. 2016](http://www.earthstat.org/water-depletion-watergap3-basins/)

'WRF\ws\_gis\\1_library\WaterGap3\WaterDepletion'

```{r}
wdp <- rast(file.path(sharepoint_dir, "WRF", "ws_gis", "1_library", "WaterGap3", "WaterDepletion", "WaterDepletionCat_WG3.tif"))
```
...
'10_RiskSuite\\RFS_New_Folders\\Data\_and_Analysis\\01_Data\\FreshwaterQuantityTargets\_Hogeboom_2024'

```{r}
bwr <- read_sf(file.path(sharepoint_dir, "10_RiskSuite", "RFS_New_Folders", "05_Data_and_Analysis", "01_Data", "FreshwaterQuantityTargets_Hogeboom_2024", "Freshwater Quantity Targets.shp"))
```
...
'WRF\ws\_gis\\1_library\WorldBank\_ML_Quality'

```{r}
nox_csv <- read_csv(file.path(sharepoint_dir, "WRF", "ws_gis", "1_library", "WorldBank_ML_Quality", "noxn_preds_05_16_19.csv"))
```
...
```{r}
sp_grid <- read_csv(file.path(sharepoint_dir, "WRF", "ws_gis", "1_library", "WorldBank_ML_Quality", "ML_data_gridcell_match.csv"))
```
...
```{r}
tnc <- rast(file.path(sharepoint_dir, "10_RiskSuite", "RFS_New_Folders", "05_Data_and_Analysis", "01_Data", "FreshwaterNutrientPollution_McDowell_2020", "data_from_author", "WQ_Variables_Extraction", "TN_Conc.tif"))
```

*Total Phosphorus Concentration*

```{r}
tpc <- rast(file.path(sharepoint_dir, "10_RiskSuite", "RFS_New_Folders", "05_Data_and_Analysis", "01_Data", "FreshwaterNutrientPollution_McDowell_2020", "data_from_author", "WQ_Variables_Extraction", "TP_Conc.tif"))
```
