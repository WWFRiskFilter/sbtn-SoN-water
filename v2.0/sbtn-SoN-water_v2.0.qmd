...
compare_wa <- son_water |> 
  st_drop_geometry() |> 
  left_join(v1.1 |> 
              select(HYBAS_ID, wa_max_1.1 = wa_max, wsb_raw_1.1 = wsb_raw, bws_raw_1.1 = bws_raw, wdp_raw_1.1 = wdp_raw),
            by = "HYBAS_ID") |> 
  mutate(wa_diff = wa_max - wa_max_1.1)
```

```{r}
## We expect changes because we replace Mekonnen et al. by Hogeboom et al.
