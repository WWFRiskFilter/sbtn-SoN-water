...
#### 2.1.3. Freshwater Quantity Targets v1.0 [Hogeboom et al. 2024](https://doi.org/10.4121/089afa18-bbd5-493e-8a6c-39e1ca7b2a59.v2)

Also called 'Freshwater Quantity Targets Target' in app recommended by SBTN (https://www.waterfootprintassessmenttool.org/hbasins/sustainability/map/blue?b=sbtn)
...
#### 3.1.3. Freshwater Quantity Targets
...
We want to check:
- How does new data compare to previous versions v1.1 and v2.0?
- How does Hogeboom v2.0 alone compared to all unified layer versions: v1.1, v2.0, v2.1?
- In v2.1, which dataset is driving risk score in each location? i.e. which dataset has the max value?

### 6.1. Compare to previous versions

```{r}

```

### 6.2. Compare Hogeboom alone v. unified


### 6.3. Identify driving dataset
...
Combined. Here we show categories where locations are driven by a particular dataset, or driven by >1.
