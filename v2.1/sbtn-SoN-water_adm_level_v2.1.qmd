...
son_water_adm1 <- adm1 |>
  ...
  # freshwater quantity target (fqt)
  left_join(exact_extract(list_wa$fqt_n, adm1, fun = "mean", append_cols = "GID_1", progress = TRUE) |> rename(fqt_n = mean), by = "GID_1") |>
  left_join(aggregate_to_adm(list_wa$fqt_n, fqt_weights$agr, fqt_agr, adm1, "GID_1"), by = "GID_1") |>
  left_join(aggregate_to_adm(list_wa$fqt_n, fqt_weights$dom, fqt_dom, adm1, "GID_1"), by = "GID_1") |>
  left_join(aggregate_to_adm(list_wa$fqt_n, fqt_weights$ind, fqt_ind, adm1, "GID_1"), by = "GID_1") |>
  left_join(aggregate_to_adm(list_wa$fqt_n, fqt_weights$tot, fqt_tot, adm1, "GID_1"), by = "GID_1") |> 
  # coastal eutrophication potential (cep)
