...
son_water_adm0 <- adm0 |>
  ...
  left_join(exact_extract(list_wa$fqt_n, adm0, fun = "mean", append_cols = "GID_0", progress = TRUE) |> rename(fqt_n = mean), by = "GID_0") |>
  left_join(aggregate_to_adm(list_wa$fqt_n, fqt_weights$agr, fqt_agr, adm0, "GID_0"), by = "GID_0") |>
  left_join(aggregate_to_adm(list_wa$fqt_n, fqt_weights$dom, fqt_dom, adm0, "GID_0"), by = "GID_0") |>
  left_join(aggregate_to_adm(list_wa$fqt_n, fqt_weights$ind, fqt_ind, adm0, "GID_0"), by = "GID_0") |>
  left_join(aggregate_to_adm(list_wa$fqt_n, fqt_weights$tot, fqt_tot, adm0, "GID_0"), by = "GID_0") |> 
